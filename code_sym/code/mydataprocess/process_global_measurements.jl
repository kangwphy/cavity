...
function _process_global_measurements(
    ...
    @show "global bin_intervals", bin_intervals
    ...
    # @show folder
    # folder = folder*"/"
    # @sprintf "%s/%d_%d_" folder N_start N_bins
    write_global_measurements((@sprintf "%s/%d_%d_" folder N_start N_bins), global_measurements_avg, global_measurements_std)
...
function write_global_measurements(folder::String, global_measurements_avg, global_measurements_std)
    ...
    open((@sprintf "%sglobal_stats.csv" folder), "w") do fout
