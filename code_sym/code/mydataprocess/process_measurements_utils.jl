...
function get_bin_intervals(folder::String, N_bins::Int, pID::Int = 0; N_start::Int = 1)
    ...
    N_files = length(files)-N_start+1
    ...
    for n_bin in 1:N_bins
        bin_interval = (n_bin-1)*N_binsize+1 + N_start-1 : n_bin*N_binsize + N_start-1
