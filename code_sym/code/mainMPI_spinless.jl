...
#md     ## in order to reconstruct the extended s-wave and d-wave pair susceptibilities.
    ...
    for bin in n_bin_burnin:N_bins_burnin
        ...
        for n in 1:bin_size
            ...
            (accepted, logdetGup, sgndetGup) = reflection_update!(
                Gup, logdetGup, sgndetGup,
                electron_photon_parameters,
                fermion_path_integral = fermion_path_integral_up,
                fermion_greens_calculator = fermion_greens_calculator_up,
                fermion_greens_calculator_alt = fermion_greens_calculator_up_alt,
                B = Bup, rng = rng, photon_types = (photon_id,)
            )
            ...
            (accepted, logdetGup, sgndetGup, δG, δθ) = hmc_update!(
                Gup, logdetGup, sgndetGup,
    ...
    for bin in n_bin:N_bins
        ...
        for n in 1:bin_size
            ...
            (logdetGup, sgndetGup, δG, δθ) = make_measurements!(
                ...
                fermion_greens_calculator = fermion_greens_calculator_up,
                # fermion_greens_calculator_dn = fermion_greens_calculator_dn,
                B = Bup, δG_max = δG_max, δG = δG, δθ = δθ,
                model_geometry = model_geometry, tight_binding_parameters = tight_binding_parameters,
                coupling_parameters = (
                    electron_photon_parameters,
                )
