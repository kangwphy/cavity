...
function _fermionic_action_derivative!(
    ...
    if ishermitian(B)
        ...
        _fermionic_action_derivative_sym!(dSdx, l, G, sgndetG, electron_photon_parameters, B, G′, G″, G‴, spin = spin)
    else
        # evaluate derivative of fermionic action for non-hermitian/asymmetric propagators
        _fermionic_action_derivative_asym!(dSdx, l, G, sgndetG, electron_photon_parameters, B, G′, G″, G‴, spin = spin)
    end
