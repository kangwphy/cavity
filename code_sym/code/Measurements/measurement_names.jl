...
@doc raw"""
    CORRELATION_FUNCTIONS = Base.ImmutableDict(
        ...
        "holegreens"           => "ORBITAL_ID",
        "holegreens_up"        => "ORBITAL_ID",
        "holegreens_dn"        => "ORBITAL_ID",
...
const CORRELATION_FUNCTIONS = Base.ImmutableDict(
    ...
    "holegreens_up"        => "ORBITAL_ID",
    "holegreens_dn"        => "ORBITAL_ID",
    "greens_onsite"           => "ORBITAL_ID",
    "greens_onsite_up"        => "ORBITAL_ID",
    "greens_onsite_dn"        => "ORBITAL_ID",
    "holegreens_onsite"           => "ORBITAL_ID",
    "holegreens_onsite_up"        => "ORBITAL_ID",
    "holegreens_onsite_dn"        => "ORBITAL_ID",
    "greens_tautau"    => "ORBITAL_ID",
    "greens_tautau_up" => "ORBITAL_ID",
    "greens_tautau_dn" => "ORBITAL_ID",
    "density"          => "ORBITAL_ID",
...
@doc raw"""
    const LOCAL_MEASUREMENTS = Base.ImmutableDict(
        ...
        "photon_kin_energy"        => "PHOTON_ID",
        "photon_pot_energy"        => "PHOTON_ID",
        "X"                        => "PHONON_ID",
        "X2"                       => "PHONON_ID",
        "X3"                       => "PHONON_ID",
        "X4"                       => "PHONON_ID",
