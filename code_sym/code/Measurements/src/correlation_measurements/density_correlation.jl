...
function density_correlation!(
    ...
    density_correlation!(DD, a, b, unit_cell, lattice, Gup_τ0, Gup_0τ, Gup_ττ, Gup_00, +1, +1, sgn, average)

    # dn-dn density-density correlation
    density_correlation!(DD, a, b, unit_cell, lattice, Gdn_τ0, Gdn_0τ, Gdn_ττ, Gdn_00, -1, -1, sgn, average)

    # up-dn density-density correlation
    density_correlation!(DD, a, b, unit_cell, lattice, Gup_τ0, Gup_0τ, Gup_ττ, Gdn_00, +1, -1, sgn, average)

    # dn-up density-density correlation
    density_correlation!(DD, a, b, unit_cell, lattice, Gdn_τ0, Gdn_0τ, Gdn_ττ, Gup_00, -1, +1, sgn, average)
...
function density_correlation!(
    ...
    if average
        ...
        ### now the size is N*N 
        for a in 1:size(DD,1)
            for b in 1:size(DD,2)
                DD[a,b] += 1 - Gσ_ττ[a,a] - Gσ′_00[b,b] + Gσ_ττ[a,a]*Gσ′_00[b,b]
                if σ == σ′
                    # @show "in",DD[a,b], Gσ_0τ[b,a]*Gσ_τ0[a,b]
                    DD[a,b] -= Gσ_0τ[b,a]*Gσ_τ0[a,b]
...
# function mydensity(DD::AbstractArray{C,D},
#     a::Int, b::Int, unit_cell::UnitCell{D}, lattice::Lattice{D},
#     Gσ_τ0::AbstractMatrix{T}, Gσ_0τ::AbstractMatrix{T},
#     Gσ_ττ::AbstractMatrix{T}, Gσ′_00::AbstractMatrix{T},
#     σ::Int, σ′::Int, sgn=one(C))
